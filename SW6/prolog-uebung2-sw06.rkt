...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname prolog-uebung2-sw06) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor mixed-fraction #f #t none #f () #f)))
; ------------ uebung 3 ------------
; a)
; (g (list 1 2 3 4 5 6))
